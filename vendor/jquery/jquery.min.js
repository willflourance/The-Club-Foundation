...
$(document).ready(function () {
	$("#seth").click(function () {
		$("#bio-seth").toggle("slow");
		$("#bio-carrie").hide("slow");
	});
});

$(document).ready(function () {
	$("#carrie").click(function () {
		$("#bio-carrie").toggle("slow");
		$("#bio-seth").hide("slow");
	});
});
...
///*** Browser resize creates dropdown menu
...
var items = $('#blogCarousel .carousel-item'), //grab all slides
